<template>
  <g>
    <g id="instruction">
      <polygon
        fill="#1C1C1C"
        points="118.737,213.492 110.468,221.551 107.623,210.36  "
      />
      <path
        fill="none"
        stroke="#1C1C1C"
      ...
      />
      <text transform="matrix(1 0 0 1 95.6667 156.166)"
        ><tspan x="0" y="0" font-size="8">Click on the spoke</tspan
        ><tspan x="0" y="9.6" font-size="8"
          >to activate the infographic</tspan
        ></text
      >
    </g>
    <g class="cycleBody">
      <path
        d="M439.868,166.682v8.865c17.967,0,32.505-14.656,32.505-32.505c0-10.638-5.319-20.094-13.237-26.477
    ...
    <g id="rear-wheel">
      ...
      >
        <rect x="130" y="295" class="spoke" width="95" height="2" />
